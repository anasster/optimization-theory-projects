...
for i = 1:numel(l_var)
    [a_f1_tmp, b_f1_tmp] = goldenSectionAlgorithm(a0, b0, l_var(i), f1);
    [a_f2_tmp, b_f2_tmp] = goldenSectionAlgorithm(a0, b0, l_var(i), f2);
    [a_f3_tmp, b_f3_tmp] = goldenSectionAlgorithm(a0, b0, l_var(i), f3);
    a_f1_2{i} = a_f1_tmp;
    a_f2_2{i} = a_f2_tmp;
    a_f3_2{i} = a_f3_tmp;
    b_f1_2{i} = b_f1_tmp;
...
sgtitle('Golden Sector Algorithm - Varying l');
...
for i = 1:numel(functions)
    figure;
    sgtitle('Golden Sector Algorithm - Variations of a_k and b_k for f_'+string(i));
    for j = 1:numel(l_var_2)
        [a, b] = goldenSectionAlgorithm(a0, b0, l_var_2(j), functions{i});
        k = 1:numel(a);
